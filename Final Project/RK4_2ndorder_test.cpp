...
int main(){
    float phi, tf, t0, h, yn, k1[2], k2[2], k3[2], k4[2], k[2], q[2], qn[2], torque_i;
    int n;
    segment vals;
    tpulse segt;
    ...
    tf = 1; // final value of deriving variable (time)
    ...
    //cout<<"-------------------\n";
    for (int i = 0; i<n; i++){
        torque_i = tcalc(segt,t0);
        fun1 = f(t0,q,vals,torque_i, 0, 0);
        k1[0] = h * fun1[0];
        k1[1] = h * fun1[1];
        
        fun2 = f(t0+h/2,q,vals,torque_i,k1[0]/2,k1[1]/2);
        k2[0] = h * fun2[0];
        k2[1] = h * fun2[1];

        fun3 = f(t0+h/2,q,vals,torque_i,k2[0]/2,k2[1]/2);
        k3[0] = h * fun3[0];
        k3[1] = h *fun3[1];

        fun4 = f(t0+h,q,vals,torque_i,k3[0],k3[1]);
        k4[0] = h * fun4[0];
        k4[1] = h * fun4[1];
